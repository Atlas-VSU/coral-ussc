    ...
    <div>
      ...
      <div className="max-w-6xl mx-auto px-2 sm:px-4 lg:px-6 pt-4 sm:pt-6 lg:pt-30 pb-8 sm:pb-4 lg:pb-6 w-full">
        <div className="flex flex-col lg:grid lg:justify-center gap-8 lg:gap-16 items-center min-h-[500px]">
          ...
          <div className="lg:hidden w-full flex justify-center items-center order-1 animate-fade-in-up"></div>

          {/* Login Form */}

          <div className="relative w-full max-w-md z-10 mx-auto my-auto">
            {/* Error Display */}
            {error && (
            ...
            {/* Malakas Maganda BG */}
            <div className="relative w-full z-10 animate-fade-in-up mx-auto my-auto">
                <form
                  onSubmit={handleSubmit}
                  className="bg-white border border-[#767676] rounded-2xl sm:rounded-[30px] lg:rounded-[40px] p-5 sm:p-6 lg:p-8 w-full max-w-[480px] sm:max-w-[500px] lg:max-w-[520px] mx-auto lg:mx-0 shadow-lg animate-fade-in-up"
                  style={{
                ...
                >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between pt-3 pb-1 space-y-3 sm:space-y-0 animate-fade-in-up">
