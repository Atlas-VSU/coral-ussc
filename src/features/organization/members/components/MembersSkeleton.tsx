  ...
  if (viewMode === "table") {
    return (
      <div className="space-y-6">
        ...
        {/* <div className="bg-gradient-to-br from-gray-100 via-blue-100 to-indigo-100 rounded-xl p-6 border border-gray-200/50 shadow-lg">
        ...
        {/* <div className="bg-gradient-to-r from-gray-100/80 via-blue-100/80 to-indigo-100/80 rounded-xl p-6 border border-gray-200/50 shadow-lg space-y-5">
          <div className="space-y-3">
            ...
            <div className="overflow-x-auto">
              <div className="min-w-full">
                ...
                {Array.from({ length: 8 }, (_, i) => (
                  <div key={i} className={`border-b border-gray-200 hover:bg-gray-50 transition-colors ${i % 2 === 0 ? "bg-gray-25" : ""}`}>
    ...
    <div className="space-y-6">
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {items.map((item) => (
            <Card key={item} className="group hover:shadow-lg transition-all duration-200 border border-gray-200 bg-white overflow-hidden h-full flex flex-col hover:border-gray-300">
        ...
        <div className="flex justify-center mt-8">
          <div className="bg-white/70 backdrop-blur-sm rounded-xl border border-gray-200/50 shadow-lg p-2">
            <div className="flex items-center gap-1">
